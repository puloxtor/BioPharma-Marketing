...
**For video generation (Seedance / Marketing Studio):** always use the canonical Marketing Studio product entity `a0b3173d-4e99-426b-8a41-29980a980907` (images #2 and #5 only). These two angles were user-approved for fidelity; more images introduced conflicting angles that caused morphing.
...
- Canonical entity ID: `a0b3173d-4e99-426b-8a41-29980a980907` (created 2026-06-03, images #2 and #5 only — user-approved angles).
  Rebuild only if these two source images change significantly. `400b1f5d` (13-img) is deprecated.
